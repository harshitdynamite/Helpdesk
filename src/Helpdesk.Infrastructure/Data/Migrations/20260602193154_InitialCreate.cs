        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SenderName = table.Column<string>(type: "character varying(320)", maxLength: 320, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_drafts_tickets_TicketId",
                        column: x => x.TicketId,
            ...
            migrationBuilder.InsertData(
                table: "users",
                columns: new[] { "Id", "CreatedAt", "DisplayName", "Email", "Role" },
                values: new object[] { new Guid("a1000000-0000-0000-0000-000000000001"), new DateTime(2026, 6, 1, 9, 0, 0, 0, DateTimeKind.Utc), "Harshit Agarwal", "harshit.agarwal.se@gmail.com", "Admin" });
